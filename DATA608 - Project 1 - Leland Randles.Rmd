...
install.packages("ggplot2", dependencies = TRUE, repos='https://mirrors.nics.utk.edu/cran/')
library(ggplot2)
...
```{r results='hide', message=FALSE, warning=FALSE}
#install.packages("dplyr", dependencies = TRUE, repos='https://mirrors.nics.utk.edu/cran/')
library(dplyr)
```
